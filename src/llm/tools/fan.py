...
set_fan_speed_tool = ChatCompletionToolParam(
    ...
    function={
        "name": "set_fan_speed",
        "description": "Set the car's fan to the target fan speed, fan speed can only between 0 and 11.",
        "parameters": {
            "type": "object",
            "properties": {
                "fan_speed": {
                    "type": "integer",
                    "description": "Target fan speed, if user provide a floating point, please round it to an integer. If the fan speed is outside the range of 0-11, please set 0 if below, and set 10 if above.",
                }
            },
            "required": ["fan_speed"],
        },
